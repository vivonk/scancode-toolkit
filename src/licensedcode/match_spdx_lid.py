...
if TRACE or os.environ.get('SCANCODE_LICENSE_DEBUG'):
    import logging
...
def build_index():
    """
    Return index data structures needed for SPDX-License-Identifier
    matching.
    """
    # collect all the SPDX license ids past and current (see
